const BLOG = {
  title: 'SHUSHU',
  author: 'shushu',
  email: 'shushu90829@gmail.com',
  link: 'https://shushupost.vercel.app/',
  description: '亂寫一通。',
  ...
  socialLink: 'https://twitter.com/SHUSHU_0829',
  seo: {
    keywords: ['Blog', 'Website', 'Notion', 'SHUSHU', '舒舒'],
  ...
  comment: {
    ...
    cusdisConfig: {
      appId: '3a9217cb-0fa2-4e22-a9fd-2dfd99d892ab', // data-app-id
